...
func generate_bindings(module_schemas: Dictionary[String, String]) -> Array[String]:
    ...
    var client_content := _generate_client_gdscript(module_schemas.keys())
    var client_output_file_name := "generated_client.gd"
    var client_output_file_path := "%s/%s" % [_schema_path, client_output_file_name]
    var client_file := FileAccess.open(client_output_file_path, FileAccess.WRITE)
    if client_file:
        client_file.store_string(client_content)
        client_file.close()
        generated_files.append(client_output_file_path)
...
func _generate_gdscript_from_schema(schema: SpacetimeParsedSchema) -> Array[String]:
    ...
    var module_content := _generate_module_gdscript(schema)
...
func _generate_module_gdscript(schema: SpacetimeParsedSchema) -> String:
    var content: String = "#Do not edit this file, it is generated automatically.\n" + \
...
func _generate_client_gdscript(modules: Array[String]) -> String:
    var content: String = "#Do not edit this file, it is generated automatically.\n" + \
    "class_name SpacetimeDBConnection extends SpacetimeDBClient\n\n"
